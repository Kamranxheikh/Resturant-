...
const Menu = () => {
  return (
    <>
      ...
      <div className='flex mt-20 justify-center space-x-2 items-center sm:text-3xl md:text-4xl text-gray-500 text-sm font-customSerif  sm:space-x-8 md:space-x-16'>
        <Link to="starter">
