    ...
    <>
      ...
      <div className='relative'>
        <img
          ...
          className="brightness-50  w-full h-[50vh] sm:h-[75vh] md:h-[75vh]  md:transition duration-500 md:ease-in-out md:transform md:hover:-translate-y-1 md:hover:scale-105 "
        />
